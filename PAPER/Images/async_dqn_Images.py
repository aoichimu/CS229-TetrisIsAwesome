...
flags.DEFINE_string('experiment', 'dqn_breakout_Images', 'Name of the current experiment')
...
def evaluation(session, graph_ops, saver):
    ...
    # Wrap env with AtariEnvironment helper class
    env = env = AtariEnvironment(gym_env=monitor_env, resized_width=FLAGS.resized_width, resized_height=FLAGS.resized_height, agent_history_length=FLAGS.agent_history_length)
    avg_reward=0
